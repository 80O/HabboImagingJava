                                    ...
                                    if (!offset.isEmpty())
                                    {
                                        ...
                                        if (data.length == 2)
                                        {
                                            ...
                                            if (f.exists())
                                            {
                                                try
                                                {
                                                    this.assetOffsetMap.put(((Element) node).getAttribute("name"), new Pair<BufferedImage, Point>(ImageIO.read(f), new Point(Integer.valueOf(data[0]), Integer.valueOf(data[1]))));
                                                } catch (Exception ex)
                                                {
