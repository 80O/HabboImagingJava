package pw.arcturus.imaging.imagers;

import org.restlet.data.Form;
import org.restlet.data.Parameter;
import pw.arcturus.Imaging;
import pw.arcturus.Pair;
import pw.arcturus.imaging.*;
...
{
    public static String defaultLook = "hr-893-45.hd-180-2.ch-210-66.lg-270-82.sh-300-91.wa-2007";
    ...
    public byte[] generate() throws Exception
    {
        ...
        if (!output.exists() || debugging)
        {
            ...
            for (String part : this.avatar.split("\\."))
            {
                ...
                //{
                //    System.out.println("Piece (" + i + "): " + definition[i]);
                //}
...
//                }
            ...
            for (AvatarParts.SetPart p : partList)
            {
                ...
                if (data != null)
                {
                    BufferedImage partImage = data.first;
                    if (p.type != AvatarParts.Type.EYE)
                    {
                        ...
                        {
                            //System.out.println(p.colorIndex);
                            //System.out.println(colors.get(p.type.colorFrom));
                            //System.out.println(secondaryColor.get(p.type.colorFrom));
                            ...
                            if (contains)
                            {
                                ...
                                //System.out.println(partImage != null);
...
//                        partImage = ImagingUtils.deepCopy(partImage);
//
//                        Color color = new Color(0xCCCCCC);
//
...
//                            {
//                                if (partImage.getRGB(x, y) == 0xCCCCCC)
//                                {
//                                    partImage.setRGB(x, y, 0xCCCCCC );
//                                }
//                            }
//                        }
//                    }
                    ...
                    if (this.bodyMirrored)
                    {
                        graphics.drawImage(partImage,
                                image.getWidth() - Math.abs(-data.second.x) - (this.headOnly ? (this.size == AvatarSize.SMALL ? 2 : 12) : 0), //Destination X1
                                image.getHeight() - data.second.y - 10  - (this.headOnly ? (this.size == AvatarSize.SMALL ? 25 : 46) : 0),  //Destination Y1
                                image.getWidth()  - Math.abs(-data.second.x) -  partImage.getWidth(),  //Destination X2
                                image.getHeight() - data.second.y - 10 + partImage.getHeight(),  //Destination Y2
                                0, //Source X1
                                0, //Source Y1
                    ...
                    {
                        graphics.drawImage(partImage, Math.abs(-data.second.x) - (this.headOnly ? (this.size == AvatarSize.SMALL ? 2 : 12) : 0), image.getHeight() - data.second.y - 10 + (this.headOnly ? (this.size == AvatarSize.SMALL ? 25 : 44) : 0), null);
                    }
                }
            }
